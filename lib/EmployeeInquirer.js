...
const
  database = new (require("./EmployeeTrackerDB"))(),
  departments = new (require("./DepartmentManager"))(database),
  roles = new (require("./RoleManager"))(database),
  employees = new (require("./EmployeeManager"))(database)
...
async function removeRole() {
  ...
  if (roleList.length) {
    ...
    showMessage("There are no empty roles eligible for removal.")
  }
  promptMainMenu()
}
